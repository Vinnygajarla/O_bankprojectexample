...
public class Account {
	...
	public String toString() {
		return "Account [accountNo=" + accountNo + ", firstName=" + firstName + ", lastName=" + lastName + ", city="
				...
				+ accountType + ", getAccountNo()=" + getAccountNo() + ", getFirstName()=" + getFirstName()
				+ ", getLastName()=" + getLastName() + ", getCity()=" + getCity() + ", getState()=" + getState()
				+ ", getAmount()=" + getAmount() + ", getCheqFacil()=" + getCheqFacil() + ", getAccountType()="
